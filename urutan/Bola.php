...
<div class="row" >
            <div class="col">
                <div class="card">
                <a href="../deskripsi/bola1.php"><img src="../foto/sepak bola/bola1.jpg" class="card-img-top" alt=""></a>
                <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                <a href="../deskripsi/bola2.php"><img src="../foto/sepak bola/bola2.jpg" class="card-img-top" alt=""></a>
                <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                <a href="../deskripsi/bola3.php"><img src="../foto/sepak bola/bola3.jpg" class="card-img-top" alt=""></a>
                <div class="card-body">                   
            ...
            <div class="col">
                <div class="card">
                <a href="../deskripsi/bola4.php"><img src="../foto/sepak bola/bola4.jpg" class="card-img-top" alt=""></a>
                <div class="card-body">                    
