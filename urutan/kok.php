...
<div class="container">
        ...
        <div class="row" >
            <div class="col">
                <div class="card">
                <a href="../deskripsi/ko1.php"><img src="../foto/bulu tangkis/cock1.jpg" class="card-img-top" alt=""></a>
                <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                <a href="../deskripsi/ko2.php"><img src="../foto/bulu tangkis/cock2.jpg" class="card-img-top" alt=""></a>
                <div class="card-body">
