...
<div class="container">
 <!-- Bulu Tangkis -->
    <div class="row" >
        ...
        <div class="col">
                <div class="card">
                <a href="../deskripsi/basket1.php"><img src="../foto/basket/bola1.jpg" class="card-img-top" alt=""></a>
                <div class="card-body">                   
            ...
            <div class="col">
                <div class="card">
                <a href="../deskripsi/basket2.php"><img src="../foto/basket/bola2.jpg" class="card-img-top" alt=""></a>
                <div class="card-body">                    
